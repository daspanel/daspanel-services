...
echo "Will create a new *$PRIVACYWORD* repo named daspanel-services"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Volume container holding DASPANEL services app, mostly writing in PHP.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"daspanel-services\", \"description\": \"Volume container holding DASPANEL services app, mostly writing in PHP.\", \"private\": $PRIVATE_TF}"
